...
public sealed class LeadTomahawkProjectile : ModProjectileBase
{
    ...
    public override bool OnTileCollide(Vector2 oldVelocity) {
        ...
        if (Main.rand.NextBool(5))
            Item.NewItem(Projectile.GetSource_Death(), Projectile.position, ModContent.ItemType<LeadTomahawkItem>());
