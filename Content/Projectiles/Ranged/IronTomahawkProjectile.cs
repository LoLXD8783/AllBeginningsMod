...
public sealed class IronTomahawkProjectile : ModProjectileBase
{
    ...
    public override bool OnTileCollide(Vector2 oldVelocity) {
        ...
        if (Main.rand.NextBool(5))
            Item.NewItem(Projectile.GetSource_Death(), Projectile.position, ModContent.ItemType<IronTomahawkItem>());
