...
namespace AllBeginningsMod.Common.GlobalItems
{
    ...
    public class CustomUseStyleProjectile : ModProjectile {
        ...
        public override void SendExtraAI(BinaryWriter writer) => customUseStyle.SendExtraAI(Projectile, Player, writer);
        public override void ReceiveExtraAI(BinaryReader reader) => customUseStyle.RecieveExtraAI(Projectile, Player, reader);

        public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox) => customUseStyle.Colliding(Projectile, Player, targetHitbox);
