...
public abstract class GreatswordProjectileBase : ModProjectile
{
    ...
    public override void ModifyDamageHitbox(ref Rectangle hitbox) {
        ...
        hitbox.X += (int) (MathF.Cos(Projectile.rotation - offset) * Projectile.width * 2);
        hitbox.Y += (int) (MathF.Sin(Projectile.rotation - offset) * Projectile.height * 2);
    }
    ...
    protected float GetProgress() {
        ...
        float progress = MathF.Abs(itemTime < 0.5f ? EaseUtils.QuadEaseIn(realTime) : EaseUtils.QuinticEaseIn(realTime));
