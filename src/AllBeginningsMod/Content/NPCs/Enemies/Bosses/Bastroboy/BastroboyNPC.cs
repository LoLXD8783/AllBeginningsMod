...
internal class BastroboyNPC : ModNPC {
    public override string Texture => Assets.Assets.Textures.NPCs.Bosses.Bastroboy.KEY_BastroboyNPC;
    ...
    private void DoJumpingMovement() {
        if(squashTimer > 0) {
            ...
            SquishSquash = -Math.Clamp(Math.Abs(NPC.velocity.Y), -10, 10) * 0.01f;
            NPC.velocity.Y += Gravity;
    ...
    public void CalculateInitialJumpVelocity() {
        ...
        initialJumpVelocity = MathUtilities.InitialVelocityRequiredToHitPosition(
            NPC.Bottom,
    ...
    public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor) {
        ...
        float aspectRatio = (float)NPC.frame.Height / NPC.frame.Width;
        Main.spriteBatch.Draw(
             ...
             drawColor,
             NPC.rotation,
             new Vector2(NPC.frame.Width / 2f, NPC.frame.Height),
